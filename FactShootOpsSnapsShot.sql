...
/****** Object:  Table [Report].[FactShootOpsSnapsShot]    Script Date: 28/07/2023 14:10:13 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [Report].[FactShootOpsSnapsShot](
	...
	[TimeInMarkAsShotState] [bigint] NULL,
	[TimeMarkAsReady] [bit] NULL,
	[OptionReceivedDateTimeStamp] [datetime] NULL,
	[OptionAssignedDateTimeStamp] [datetime] NULL
) ON [PRIMARY]
GO

ALTER TABLE [Report].[FactShootOpsSnapsShot]  WITH CHECK ADD FOREIGN KEY([DateId])
REFERENCES [Report].[DimDate] ([DateId])
GO

ALTER TABLE [Report].[FactShootOpsSnapsShot]  WITH CHECK ADD FOREIGN KEY([EventTypeId])
REFERENCES [Report].[DimEventType] ([EventTypeId])
GO

ALTER TABLE [Report].[FactShootOpsSnapsShot]  WITH CHECK ADD FOREIGN KEY([GoalTypeId])
REFERENCES [Report].[DimGoalType] ([GoalTypeId])
GO

ALTER TABLE [Report].[FactShootOpsSnapsShot]  WITH CHECK ADD FOREIGN KEY([LocationId])
REFERENCES [Report].[DimLocation] ([LocationId])
GO

ALTER TABLE [Report].[FactShootOpsSnapsShot]  WITH CHECK ADD FOREIGN KEY([ReasonCodeId])
REFERENCES [Report].[DimReasonCode] ([ReasonId])
GO

ALTER TABLE [Report].[FactShootOpsSnapsShot]  WITH CHECK ADD FOREIGN KEY([ShootDateId])
REFERENCES [Report].[DimShootDate] ([ShootDateId])
GO

ALTER TABLE [Report].[FactShootOpsSnapsShot]  WITH CHECK ADD FOREIGN KEY([ShootTimeId])
REFERENCES [Report].[DimShootTime] ([ShootTimeId])
GO

ALTER TABLE [Report].[FactShootOpsSnapsShot]  WITH CHECK ADD FOREIGN KEY([SourceTypeId])
REFERENCES [Report].[DimSourceType] ([SourceTypeId])
GO

ALTER TABLE [Report].[FactShootOpsSnapsShot]  WITH CHECK ADD FOREIGN KEY([UserId])
